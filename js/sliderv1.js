(function($) {
	$.fn.easyTradePayoutSlider = function(options) {
		...
		// Legend
		var downLabel = $('<div class="slider-legend down">Down</div>');
		var currencyLabel = $('<div class="slider-legend currency">Eur</div>');
		var upLabel = $('<div class="slider-legend up">Up</div>');
		// Slider mode
